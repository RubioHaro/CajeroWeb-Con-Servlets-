 ...
 * @author Rod
 */
public class Accionar extends HttpServlet {
    ...
    public void doPost(HttpServletRequest peticion, HttpServletResponse respuesta) throws ServletException, IOException {
        user = new Usuario();
        UserTag = peticion.getParameter("Submit");
        ...
        if (validar()) {
            try (PrintWriter out = new PrintWriter(respuesta.getOutputStream())) {
                ...
                out.println(""
                        ...
                        + "                                    <br>"
                        + "                                    <div class=\"text-center \"><input class=\"btn-danger\" type=submit   value=\"Retirar\"/></div>\n"
                        + "                                </form>\n"
                        + "                            </div>\n"
                        + "                        </div>\n"
                        + "                    </div>\n"
